...
public class ExpiryMap<K, V> extends ConcurrentHashMap<K, V>{
     ...
     * default expiry time
     */
    private long EXPIRY = 1000 * 60 * 60 * 24 * 365 * 10000;
    ...
    public boolean containsValue(Object value) {
        ...
        Iterator<java.util.Map.Entry<K, V>> iterator = super.entrySet().iterator();
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        System.out.println("size:" + ((ConcurrentHashMap<String, String>)map).size());
